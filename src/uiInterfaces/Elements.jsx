	...
	return (
		<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
			<div className="lg:col-span-2 flex">
				...
				<div className="w-[78%] md:w-[82%] lg:w-[90%] xl:w-[92%] ">
					<div className="relative">
						...
						<input
							type="text"
							className="border border-[#686868] w-full md:w-[90%] lg:w-[55%] xl:w-[45%] text-[#9A9A9A] text-sm rounded-full block pl-10 p-2.5"
							placeholder="Search"
							autoComplete="off"
							value={searchName}
